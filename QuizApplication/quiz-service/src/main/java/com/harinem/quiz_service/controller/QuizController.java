package com.harinem.quiz_service.controller;


import com.harinem.quiz_service.model.QuestionWrapper;
import com.harinem.quiz_service.model.QuizDto;
import com.harinem.quiz_service.model.UserResponse;
import com.harinem.quiz_service.service.QuizService;
...
public class QuizController {
    ...
    public ResponseEntity<String> createQuiz(@RequestBody QuizDto quizDto){
        return quizService.createQuiz(quizDto.getDifficulty(),quizDto.getNumberOfQuestion(),quizDto.getTitle());
